...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
            ...
            if (przedmiot == null)
            {
                return new List<string> { "Brak przedmiotu z kategorii Analytics." };
            }
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        ...
        return new List<string>
        {
        $"Czy istnieje przynajmniej jeden nieaktywny zapis? {(czyIstnieje ? "Tak" : "Nie")}"
        };
    }
    ...
    {
        bool wszyscyMajaKatedre = DaneUczelni.Prowadzacy
        .All(p => !string.IsNullOrWhiteSpace(p.Katedra));

        return new List<string>
        {
        $"Wynik: {wszyscyMajaKatedre}"
        };
    }
    ...
    {
        int liczbaAktywnych = DaneUczelni.Zapisy
        .Where(z => z.CzyAktywny)
        .Count();

        return new List<string>
        {
        $"Liczba aktywnych zapisów: {liczbaAktywnych}"
        };
    }
    ...
    public IEnumerable<string> Zadanie09_TrzyNajnowszeZapisy()
    {
        ...
        .Take(3)
        .Select(z => $"Data: {z.DataZapisu:yyyy-MM-dd HH:mm} | Student: {z.StudentId} | Przedmiot: {z.PrzedmiotId}");
    }
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
       ...
       .SelectMany(z =>
           DaneUczelni.Studenci
               .Where(s => s.Id == z.StudentId)
               .SelectMany(s =>
                   DaneUczelni.Przedmioty
                       .Where(p => p.Id == z.PrzedmiotId)
                       .Select(p => $"{s.Imie} {s.Nazwisko} | {p.Nazwa}")
               )
       );
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        ...
        .GroupBy(x => x.Nazwa)
        .Select(g => $"{g.Key} | Średnia ocena: {g.Average(x => x.OcenaKoncowa):F2}");
    }
        ...
        return DaneUczelni.Studenci
            .Join(
                ...
                (s, z) => new
                {
                    s.Imie,
                    s.Nazwisko,
                    Ocena = z.OcenaKoncowa.Value
                }
            )
            .GroupBy(x => new { x.Imie, x.Nazwisko })
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} | Najwyższa ocena: {g.Max(x => x.Ocena)}");
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy.GroupJoin
            (
            DaneUczelni.Przedmioty,pr => pr.Id,p => p.ProwadzacyId,(pr, przedmioty) => new
                {
                    Prowadzacy = pr,
            ...
            .Where(x => x.Oceny.Any())
            .Select(x => $"{x.Imie} {x.Nazwisko} | Średnia ocen: {x.Oceny.Average():F2}");
    }
